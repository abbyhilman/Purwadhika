...
class cart extends React.Component {
  ...
  renderTaxFee = () => {
    return this.renderSubTotalPrice() * 0.5;
  };
  ...
  payBtnHandler = () => {
    ...
    if (this.state.payment > this.renderTotalPrice()) {
      alert(
        `Success anda Mendapatkan kembalian ${
    ...
    Axios.post(`${API_URL}/transactions`, {
      ...
      transactionItems: this.props.cartGlobal.cartList, // Array of object -> cart
    })
      .then((res) => {
        alert("Berhasil melakukan pembayaran");
        res.data.transactionItems.forEach((item) => {
          this.deleteCartHandler(item.id);
        });
        this.setState({
          recipientName: "",
          address: "",
            ...
            <table className="table">
              ...
              <tfoot className="bg-light">
                <tr>
                  <td colSpan="6">
                    <button
                      onClick={this.checkoutModeToogle}
